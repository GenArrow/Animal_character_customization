/********************************************************************************
** Form generated from reading UI file 'addwindowdog.ui'
**
...
#ifndef UI_ADDWINDOWDOG_H
#define UI_ADDWINDOWDOG_H
...
public:
    ...
    void setupUi(QMainWindow *AddWindowDog)
    {
        if (AddWindowDog->objectName().isEmpty())
            AddWindowDog->setObjectName(QString::fromUtf8("AddWindowDog"));
        AddWindowDog->resize(400, 422);
        AddWindowDog->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:pad, x1:0.614, y1:0, x2:0.608, y2:1, stop:0 rgba(113, 176, 211, 255), stop:1 rgba(55, 236, 186, 255));"));
        centralwidget = new QWidget(AddWindowDog);
        ...
        AddWindowDog->setCentralWidget(centralwidget);
        menubar = new QMenuBar(AddWindowDog);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 400, 21));
        AddWindowDog->setMenuBar(menubar);
        statusbar = new QStatusBar(AddWindowDog);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        AddWindowDog->setStatusBar(statusbar);

        retranslateUi(AddWindowDog);

        QMetaObject::connectSlotsByName(AddWindowDog);
    } // setupUi

    void retranslateUi(QMainWindow *AddWindowDog)
    {
        AddWindowDog->setWindowTitle(QCoreApplication::translate("AddWindowDog", "AddWindow", nullptr));
        label->setText(QCoreApplication::translate("AddWindowDog", "Name:", nullptr));
        ColorCatButton->setText(QCoreApplication::translate("AddWindowDog", "Pick Color", nullptr));
        label_2->setText(QCoreApplication::translate("AddWindowDog", "Hat?   ", nullptr));
        checkBoxHat->setText(QString());
        ColorHatButton->setText(QCoreApplication::translate("AddWindowDog", "Pick Color", nullptr));
        label_3->setText(QCoreApplication::translate("AddWindowDog", "Glasses?", nullptr));
        radioButton3D->setText(QCoreApplication::translate("AddWindowDog", "3D Glasses", nullptr));
        radioButtonSUN->setText(QCoreApplication::translate("AddWindowDog", "Sunglasses", nullptr));
        label_4->setText(QCoreApplication::translate("AddWindowDog", "Pendant?", nullptr));
        checkBoxPendant->setText(QString());
        label_5->setText(QCoreApplication::translate("AddWindowDog", "ID:      ", nullptr));
        pushButton->setText(QCoreApplication::translate("AddWindowDog", "Done", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AddWindowDog: public Ui_AddWindowDog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDWINDOWDOG_H
